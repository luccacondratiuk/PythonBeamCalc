class Viga():
    def __init__(self, length:float, reactions:list, single_loads: list, distributed_loads:list, inertias: list):
        ...
        self.inertias = inertias # cria um atributo com os momentos de inércia e suas respectivas posições, também informados pelo usuário
        self.sectionsData = []
        self.forceBalance()
        self._sections()
